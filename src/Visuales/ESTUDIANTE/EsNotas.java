...
public class EsNotas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("UNIVERSIDAD A INGRESAR");
        ...
        getContentPane().add(jLayeredPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 350, 630));

        jLayeredPane2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));

        jPanel2.setBackground(new java.awt.Color(249, 245, 162));
        ...
        getContentPane().add(jLayeredPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 0, 940, 630));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EsNotas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
