 ...
 * @author Monica
 */
public class crearMate extends javax.swing.JFrame {

    
    Profesor profesor;
    
    public crearMate(Profesor profesor) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("CREACION DE MATERIAL");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sources/imagen_2024-11-05_025449265.png"))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        FileNameExtensionFilter filtro = new FileNameExtensionFilter("Archivos de texto", "pdf");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(crearMate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new crearMate(null).setVisible(true);
            }
        });
    }
